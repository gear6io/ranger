// SQL parser ast package is a collection of types that represent the abstract syntax tree of a parsed SQL statement.
...
// Note: Type definitions are in parser.go to avoid duplication
