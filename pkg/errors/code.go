...
// Filesystem codes
func FilesystemCode(name string) Code {
	return MustNewCode("filesystem." + name)
}

// Memory codes
func MemoryCode(name string) Code {
	return MustNewCode("memory." + name)
}

// Query codes
func QueryCode(name string) Code {
	return MustNewCode("query." + name)
}

// Storage codes
func StorageCode(name string) Code {
	return MustNewCode("storage." + name)
}

// Network codes
func NetworkCode(name string) Code {
	return MustNewCode("network." + name)
}

// Auth codes
func AuthCode(name string) Code {
	return MustNewCode("auth." + name)
}

// Database codes
func DatabaseCode(name string) Code {
	return MustNewCode("database." + name)
}

// API codes
func APICode(name string) Code {
	return MustNewCode("api." + name)
}

// Custom package code constructor
func PackageCode(packageName, name string) Code {
	return MustNewCode(packageName + "." + name)
}
